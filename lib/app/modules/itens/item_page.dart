              ...
              children: [
                ...
                Padding(
                  ...
                  child: DropdownButtonFormField(
                    value: store.form.controls['categoria']!.value != null ? (store.form.controls['categoria']!.value as Map<String, dynamic>)['id'] : 0,
                    ...
                    onChanged: (value) {
                      for (CategoriaModel categoria in store.categorias) {
                        if(categoria.id == value) {
                          store.form.controls['categoria']?.updateValue(categoria.toJson());
                        }
                      }
                    },
                  ),
